...
<body class="hold-transition sidebar-mini">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body">
                        <h4 class="d-flex justify-content-center">Apakah Anda Yakin Ingin Logout?</h4>
                    </div>
    ...
    <div class="wrapper">
                ...
                <li class="nav-item">
                    <div class="dropstart">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <button disabled type="button" class="button-profil" style="cursor: context-menu;">
        ...
        <aside class="main-sidebar sidebar-white-primary elevation-4" style="background-color: whitesmoke;">
            <!-- Brand Logo -->
